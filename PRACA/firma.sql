...
--
-- Host: 127.0.0.1
-- Generation Time: Cze 02, 2024 at 08:59 AM
...
CREATE TABLE `dochody` (
  ...
  `id_cel` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `przypisania_dochodow_do_celow`
--

CREATE TABLE `przypisania_dochodow_do_celow` (
  `id` int(11) NOT NULL,
  `dochod_id` int(11) DEFAULT NULL,
...
ALTER TABLE `dochody`
  ...
  ADD KEY `id_cel` (`id_cel`);

--
-- Indeksy dla tabeli `przypisania_dochodow_do_celow`
--
ALTER TABLE `przypisania_dochodow_do_celow`
  ADD PRIMARY KEY (`id`),
  ADD KEY `dochod_id` (`dochod_id`),
...
--
-- AUTO_INCREMENT for table `przypisania_dochodow_do_celow`
--
ALTER TABLE `przypisania_dochodow_do_celow`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `cele`
  ...
  ADD CONSTRAINT `cele_ibfk_2` FOREIGN KEY (`id_dochody`) REFERENCES `przypisania_dochodow_do_celow` (`dochod_id`);
...
ALTER TABLE `dochody`
  ...
  ADD CONSTRAINT `dochody_ibfk_3` FOREIGN KEY (`id_cel`) REFERENCES `przypisania_dochodow_do_celow` (`cel_id`);

--
-- Constraints for table `przypisania_dochodow_do_celow`
--
ALTER TABLE `przypisania_dochodow_do_celow`
  ADD CONSTRAINT `przypisania_dochodow_do_celow_ibfk_1` FOREIGN KEY (`dochod_id`) REFERENCES `dochody` (`id`),
  ADD CONSTRAINT `przypisania_dochodow_do_celow_ibfk_2` FOREIGN KEY (`cel_id`) REFERENCES `cele` (`id`);
